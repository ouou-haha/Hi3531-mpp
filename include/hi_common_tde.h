 ...
 * Description: tde type
 * Author: Hisilicon multimedia software group
 * Create: 2018/10/30
 */
#ifndef __HI_COMMON_TDE_H__
#define __HI_COMMON_TDE_H__
...
typedef enum {
    HI_TDE_MB_COLOR_FORMAT_JPG_YCbCr400MBP = 0, /* Semi-planar YUV400 format, for JPG decoding */
    /* Semi-planar YUV422 format, horizontal sampling, for JPG decoding */
    HI_TDE_MB_COLOR_FORMAT_JPG_YCbCr422MBHP,
    HI_TDE_MB_COLOR_FORMAT_JPG_YCbCr422MBVP, /* Semi-planar YUV422 format, vertical sampling, for JPG decoding */
    HI_TDE_MB_COLOR_FORMAT_MP1_YCbCr420MBP,  /* Semi-planar YUV420 format */
    HI_TDE_MB_COLOR_FORMAT_MP2_YCbCr420MBP,  /* Semi-planar YUV420 format */
    HI_TDE_MB_COLOR_FORMAT_MP2_YCbCr420MBI,  /* Semi-planar YUV420 format */
    HI_TDE_MB_COLOR_FORMAT_JPG_YCbCr420MBP,  /* Semi-planar YUV420 format, for JPG pictures */
    HI_TDE_MB_COLOR_FORMAT_JPG_YCbCr444MBP,  /* Semi-planar YUV444 format, for JPG pictures */
    HI_TDE_MB_COLOR_FORMAT_MAX
} hi_tde_mb_color_format;

/* Structure of the bitmap information set by customers */
typedef struct {
    hi_phys_addr_t phys_addr; /* Header address of a bitmap or the Y component */
    hi_u32 phys_len;
    ...
    hi_phys_addr_t cbcr_phys_addr;    /* Address of the CbCr component, pilot */
    ...
    hi_phys_addr_t clut_phys_addr;
    hi_u32 clut_phys_len;
} hi_tde_surface;

/* Definition of the semi-planar YUV data */
typedef struct {
    hi_tde_mb_color_format mb_color_format; /* YUV format */
    hi_phys_addr_t y_addr;             /* Physical address of the Y component */
    hi_u32 y_len;
    ...
    hi_phys_addr_t cbcr_phys_addr;      /* Width of the UV component */
    hi_u32 cbcr_phys_len;
...
typedef enum {
    ...
    HI_TDE_MIRROR_HOR, /* Horizontal mirror */
    HI_TDE_MIRROR_VER,   /* Vertical mirror */
...
typedef struct {
    ...
    hi_phys_addr_t src_csc_param_addr; /* ICSC parameter address. The address must be 128-bit aligned. */
    hi_s32 src_csc_param_len;
    hi_phys_addr_t dst_csc_param_addr; /* OCSC parameter address. The address must be 128-bit aligned. */
...
typedef struct {
    ...
    hi_u32 inner_color;
    hi_u32 outer_color;
} hi_tde_corner_rect_info;

typedef struct {
    hi_tde_rect *corner_rect_region;
    hi_tde_corner_rect_info *corner_rect_info;
} hi_tde_corner_rect;
...
#endif
#endif /* End of #ifdef __cplusplus */
#endif /* End of #ifndef __HI_COMMON_TDE_H__ */
