...
hi_s32 hi_mpi_vdec_set_low_delay_attr(hi_vdec_chn chn, const hi_low_delay_info *low_delay_attr);
hi_s32 hi_mpi_vdec_get_low_delay_attr(hi_vdec_chn chn, hi_low_delay_info *low_delay_attr);
