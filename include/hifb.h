...
typedef struct {
    ...
    hi_u32  ver_deflicker_level;   /* vertical deflicker level, 0 means vertical deflicker is unsupporteded. */
    hi_u32  hor_deflicker_level;   /* horizontal deflicker level, 0 means horizontal deflicker is unsupporteded. */
...
typedef struct {
    ...
    hi_s32 x_pos;           /*  the x pos of origin point in screen */
    hi_s32 y_pos;           /*  the y pos of origin point in screen */
    ...
    hi_bool is_premul;      /*  The data drawn in buf is premul data or not */
