 ...
 *
 * Example:
 * ALIGN UP, HI_ALIGN_UP(5,4) = 8
 * ALIGN DOWN, HI_ALIGN_DOWN(5,4)   = 4
 */
 ...
 * IS_ITTLE_END()            whether the system is little end mode
 */
#define  ENDIAN32(x)                   \
    (((x) << 24) |                     \
    (((x) & 0x0000ff00) << 8) |        \
...
__inline static hi_void init_fps(fps_ctrl *frame_ctrl, hi_u32 full_fps, hi_u32 tag_fps)
{
