...
typedef enum {
    ...
    HI_ERR_AAC_NCHANS_TOO_HIGH               = -15,    /* unsupported mutil channel */
    ...
    HI_ERR_AAC_SBR_NCHANS_TOO_HIGH           = -20,    /* unsupported SBR multi channel */
    ...
    HI_ERR_AAC_TRANSPORT_FATAL_ERROR         = 4099,   /* The transport decoder occut fatal error. Reset Transport */
