...
#define HI_POOL_OWNER_MODULE              (-3)
#define HI_POOL_OWNER_USER                (-4)
...
#define HI_VB_SUPPLEMENT_MOTION_DATA_MASK 0x2
#define HI_VB_SUPPLEMENT_DNG_MASK         0x4
#define HI_VB_SUPPLEMENT_MISC_MASK        0x8
#define HI_VB_SUPPLEMENT_BNR_MOT_MASK     0x10
