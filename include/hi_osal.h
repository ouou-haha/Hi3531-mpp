...
int osal_strnicmp(const char *s1, const char *s2, int size);
...
void osal_rtc_tm_to_time(const osal_rtc_time_t *tm, unsigned long *time);
int osal_rtc_valid_tm(const struct osal_rtc_time *tm);
