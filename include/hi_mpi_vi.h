 ...
 * Description: vi mpi interface function declaration
...
hi_s32 hi_mpi_vi_release_frame(hi_vi_chn vi_chn, const hi_video_frame_info *frame_info);
...
hi_s32 hi_mpi_vi_set_user_pic(hi_vi_chn vi_chn, const hi_vi_user_pic_attr *user_pic);
 ...
 */
hi_s32 hi_mpi_vi_set_vbi_attr(hi_vi_chn vi_chn, const hi_vi_vbi_arg *vbi_attr);
hi_s32 hi_mpi_vi_get_vbi_attr(hi_vi_chn vi_chn, hi_vi_vbi_arg *vbi_attr);
hi_s32 hi_mpi_vi_set_vbi_mode(hi_vi_chn vi_chn, const hi_vi_vbi_mode mode);
...
hi_s32 hi_mpi_vi_set_skip_mode_ex(hi_vi_chn vi_chn, const hi_vi_skip_mode_ex *mode_ex);
