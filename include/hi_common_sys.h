...
typedef enum {
    HI_VI_VIDEO_MODE_NORM = 0,
    HI_VI_VIDEO_MODE_ADVANCED,

    HI_VI_VIDEO_MODE_BUTT
} hi_vi_video_mode;

typedef enum {
    HI_EXT_CHN_SRC_TYPE_TAIL = 0,
    HI_EXT_CHN_SRC_TYPE_BEFORE_FISHEYE,
    HI_EXT_CHN_SRC_TYPE_HEAD,
    HI_EXT_CHN_SRC_TYPE_BUTT
} hi_ext_chn_src_type;
