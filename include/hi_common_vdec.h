...
* Description:Common definition Of video decode
...
typedef struct {
    ...
    union {
         ...
         * AUTO:hi_payload_type:HI_PT_H264, HI_PT_H265, HI_PT_MP4VIDEO;
         */
...
typedef struct {
    ...
    hi_s32 stream_unsupport;  /* R; Unsupported stream specification. */
